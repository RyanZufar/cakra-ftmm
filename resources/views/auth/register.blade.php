...
<body class="gradient-bg text-white">
    ...
    <main class="w-full max-w-md p-8 space-y-8">
        <div class="text-center">
            ...
            <p class="text-gray-400 mt-2">Daftar sebagai Mahasiswa</p>
        </div>
        ...
        <div class="bg-card-bg backdrop-blur-sm p-8 rounded-2xl card-glow border border-primary/20">
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    <label for="name" class="block text-sm mb-1 text-gray-300">Nama Lengkap</label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm mb-1 text-gray-300">Konfirmasi Password</label>
                ...
                <p class="text-center text-sm text-gray-400 pt-4">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="font-semibold text-white hover:text-primary/80 transition-colors">Login di sini</a>
                </p>
            </form>
        </div>
    </main>
